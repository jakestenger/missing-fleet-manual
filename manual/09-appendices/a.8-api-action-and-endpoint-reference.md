...
![Reference](../_assets/icons/reference-light.svg) Verified against Fleet 4.91.0. `v1` and `2022-04` are what the **core** module declares at this release; other modules declare their own, and `latest` is added to whatever set each declares.
