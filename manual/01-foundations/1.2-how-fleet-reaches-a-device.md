...
<!-- IMAGE-REDO: assets/1.2-five-channels.webp
     WHY: reviewed 2026-08-24. Everything asked for last time is fixed: flat outlines,
     correct terminology, no invented hues. The result is simply dull. Five near-identical
     navy arrows on faint bands do not communicate that these are five independent things,
     which is the entire claim of the picture. The dot colours below are the fix.
