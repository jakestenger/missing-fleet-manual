...
>
> **The organisation-wide settings document is audited by exception rather than as a document.** Around forty specific changes inside it each write their own activity: agent options, enroll secrets, disk encryption on and off, Windows MDM on and off, minimum OS versions, the integrations, GitOps mode, and so on.
>
