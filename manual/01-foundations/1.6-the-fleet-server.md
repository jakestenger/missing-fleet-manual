...
<!-- IMAGE-REDO: assets/1.6-fleet-service-state-model.webp
     WHY: reviewed 2026-08-24. Structurally good, and the "loss costs" line beneath each
     card earns its place; keep both. It is drawn almost entirely in hairline outlines with
     fills so pale they read as white, so the three stores look interchangeable when the whole
     point is that they are not. Colour and weight below.
