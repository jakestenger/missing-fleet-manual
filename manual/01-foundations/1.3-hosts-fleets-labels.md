...
[a.6](../09-appendices/a.6-glossary-and-release-compatibility.md) carries the full mapping of which surface uses which name, including how Unassigned is stored, which is not one shape.
