...
**Named fleets require Fleet Premium.** Free has a single scope for all hosts. Labels exist in both editions, with separate licence requirements for some targeting features.
