...
Fleet’s role model lets you share device-management work with the people who know those devices best. A support group can look after its own fleet, a security reviewer can inspect device information, and an automation account can carry out a defined workflow. You decide the kind of work each account can perform and where it can perform it.
