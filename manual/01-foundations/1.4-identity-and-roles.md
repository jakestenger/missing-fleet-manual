...
[2.3](../02-administer-and-deploy-fleet/2.3-user-accounts-roles-and-service-identities.md) covers which role to choose. [a.4](../09-appendices/a.4-roles-and-permissions-matrix.md) carries the exhaustive breakdown, action by action against all six roles at both scopes.
