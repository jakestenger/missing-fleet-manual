...
Fleet helps you see the state of the devices you manage and change them in controlled, auditable ways. Many organizations split those jobs between an inventory tool and mobile device management (MDM); Fleet gives both jobs one device record and one **control plane**, a single place that both sees a device's state and changes it.
