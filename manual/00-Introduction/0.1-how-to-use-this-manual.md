...
If you know **the device type** and want to know what is possible on it, the [platform capability matrix](../09-appendices/a.2-platform-capability-matrix.md) will answer questions like what Fleet can do on Android. **It is not written yet**, so until it is, the chapter that owns a capability is where its platform answers live, and [1.1](../01-foundations/1.1-what-fleet-is.md) has the overview.
