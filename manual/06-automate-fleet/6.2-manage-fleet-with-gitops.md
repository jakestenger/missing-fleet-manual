...
<!-- IMAGE-TODO: assets/6.2-gitops-assignment-loss-window.webp
     ...
     PROMPT: DIAGRAM: A focused Premium, multi-file apply sequence: Existing assignments → Clear
     assignments for fleets not yet created → Create/configure fleets → Restore assignments. Shade
