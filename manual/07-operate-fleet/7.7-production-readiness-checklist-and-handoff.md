...
![Explanation](../_assets/icons/explanation.svg) A production handoff transfers standing obligations, not just a running server. This chapter covers what is actually being handed over, the obligations that have no published procedure, and what has to be true before a deployment carries real hosts.
