...
Set the Windows key per fleet or across all fleets, through the REST API or GitOps at `mdm.windows_settings.enable_managed_local_account`. Enabling and disabling it are each recorded as an activity, as on macOS.
