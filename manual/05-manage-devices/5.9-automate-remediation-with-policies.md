...
verified_source: "drafted against fleet-v4.90.0 (7c428c6e46); the patch-when-closed patch-policy option added in 4.91 verified against fleet-v4.91.0 (35fc1c0244); citation ledger at research/section-notes/5.9-notes.md. Working research is held outside this repository, see research/section-notes/README.md"
further_reading:
...
Fleet turns patch when closed on by default for a new patch policy. The GitOps key is `patch_when_closed`, and it applies only alongside `patch: true` on a Fleet-maintained app. Fleet rejects it on a title you packaged yourself, because the closed-app check depends on the maintained-app manifest.
