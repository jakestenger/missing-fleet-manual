...
Fleet contains and erases the device. It does not touch the accounts and access that device carried, and a locked or wiped endpoint is not a secured identity. The rule from [0.3](../00-Introduction/0.3-how-to-use-this-manual.md) holds here too: for the parts Fleet does not own, it names what you still have to bring. Bring these in parallel with the steps above, not once they finish.
