...
![Reference](../_assets/icons/reference-light.svg) Every deployment includes the activity record. Premium adds automatic delivery of eligible activity events to an external destination.
...
![Reference](../_assets/icons/reference-light.svg) Configure each stream you need. Choosing an osquery-results destination leaves the status and activity-audit destinations unchanged.
...
![Explanation](../_assets/icons/explanation-light.svg) Most organizations reach for external delivery for one of three reasons, and they lead to different answers.
...
![How-to](../_assets/icons/howto-light.svg) Two server settings control this, and the second only matters once the first is on.
...
![How-to](../_assets/icons/howto-light.svg) Make a low-risk, clearly identifiable change: rename a test label, or create and delete a placeholder. Something you can search for unambiguously.
...
![Reference](../_assets/icons/reference-light.svg) Verified against Fleet 4.90.0. External audit-log delivery is a Fleet Premium capability; the activity record and the Activities API are available at every tier. The documented delay before an event is written is up to five minutes.
