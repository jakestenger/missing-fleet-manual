...
<!-- IMAGE-REDO: 2.1-setup-sequence.webp
     WHY: measured off-palette. Not individually inspected, and it came from the same batch as the
     2.2 image that drew vehicles, so check the subject matter too.
