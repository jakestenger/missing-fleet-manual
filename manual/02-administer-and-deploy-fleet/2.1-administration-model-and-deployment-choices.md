...
![Explanation](../_assets/icons/explanation.svg) There are two ways to run Fleet, and for most organizations the choice is made for them.
...
![How-to](../_assets/icons/howto.svg) This sounds like bureaucracy and is not. Every one of these has a moment, usually at 2am, when someone needs to know the answer, and the cost of not having decided in advance is paid entirely at that moment.
...
![How-to](../_assets/icons/howto.svg) Choose a pilot fleet with clear ownership and people who can tell you when something feels wrong from the end-user side. This is not a rehearsal. It is the first real deployment, run somewhere the consequences are small.
...
![Explanation](../_assets/icons/explanation.svg) Most of what this chapter covers can be changed later at moderate cost. Four things cannot, and they are worth settling before the first device enrolls.
...
**Your database platform.** Fleet supports one writable primary with read replicas, and does not support multi-writer or group-replication clusters. If your platform standard is a multi-writer cluster, that has to be resolved before deployment rather than discovered during it.
...
The rest of the setup sequence tolerates iteration. These four do not, which is the reason they appear this early rather than in the chapters that cover them in full.
