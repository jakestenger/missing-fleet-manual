...
**The server URL.** Changing it after Apple devices have MDM turned on requires an end user to turn MDM off and back on, per device, by hand. [2.4](2.4-organization-and-server-settings.md) covers what else it reaches.
