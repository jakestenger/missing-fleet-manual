...
[1.4 Identity and roles](../01-foundations/1.4-identity-and-roles.md) explains why the model is shaped this way. [2.5](2.5-identity-providers-sso-scim-and-role-sync.md) covers connecting an identity provider so accounts are created and removed for you. The exhaustive action-by-action breakdown is [a.4 Roles and permissions matrix](../09-appendices/a.4-roles-and-permissions-matrix.md). **This chapter is the model rather than the matrix**, and it gives you enough to choose correctly.
