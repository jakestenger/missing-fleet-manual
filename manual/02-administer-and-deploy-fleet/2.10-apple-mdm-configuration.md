...
![How-to](../_assets/icons/howto.svg) The opposite of the section above, and the one action in this chapter you cannot take back. **Release from Apple Business**, on a host's **Actions** menu, tells Apple to disown the device: it leaves your Apple Business organization entirely. It is Fleet Premium.
...
**Apple Business has to permit it.** The setting is **Allow this service to release devices** on the Apple Business side. With it off, Apple rejects the request and Fleet reports that specific reason against the host rather than a generic failure, which is the one error here worth reading carefully.
...
**What happens to the host record depends on whether the device ever enrolled**, and the difference matters:
