...
<!-- IMAGE-OK: assets/2.2-identity-provider-jobs.webp
...
Three things cause Fleet to reject the sign-in outright rather than fall back to a default, and all three are worth knowing before you are debugging one:
...
- Every role and what it can do: [a.4 Roles and permissions matrix](../09-appendices/a.4-roles-and-permissions-matrix.md), action by action against all six roles at both scopes. [2.3](2.3-user-accounts-roles-and-service-identities.md) explains the model behind it and is the fullest account
