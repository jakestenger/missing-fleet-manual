...
<!-- IMAGE-REDO: assets/2.2-identity-provider-jobs.webp
     WHY: the box labelled "Fleet" contains a laptop displaying cars, vans and trucks. The
     image model read the product name as a fleet of vehicles. The labels also use em-dashes,
     which this manual does not use in rendered text.
     ...
     "at sign-in". A second brace on the fourth is labelled "continuously, out of band". Put
     the single Fleet Green accent on the fourth arrow, because it is the one that is not
     tied to a sign-in.
