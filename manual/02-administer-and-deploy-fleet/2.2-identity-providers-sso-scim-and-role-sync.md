...
<!-- DIAGRAM: Scope diagram, four jobs one identity provider. A single "Identity provider"
     box on the left. Four labelled arrows to a "Fleet" box on the right, stacked. Top to
     bottom: "SAML sign-in — proves identity", "JIT — creates the account", "SAML attributes
     — sets the role", "SCIM — removes the account, and maps device owners". Group the
     first three with a brace labelled "at sign-in" and the fourth with a brace labelled
     "continuously, out of band". Caption: "One identity provider, four jobs, two protocols."
     Flat vector, generous whitespace, legible at half width. -->
...
- [1.5 Audit and activity](../01-foundations/1.5-audit-and-activity.md)
