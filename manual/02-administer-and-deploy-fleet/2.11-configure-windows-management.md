...
Windows management uses a certificate and private key you generate. Choose their lifetime and custody before enrollment: replacing or renewing the certificate can make existing escrowed recovery keys unreadable.
...
![Explanation](../_assets/icons/explanation.svg) You choose the lifetime of the self-signed certificate; Fleet’s example uses ten years. There is no vendor renewal service. Preserve the original certificate and private key because existing disk-encryption escrow requires that certificate’s identity.
...
![How-to](../_assets/icons/howto.svg) Fleet uses your self-signed certificate and private key for Windows enrollment. Track the expiry you choose; no external authority renews it.
