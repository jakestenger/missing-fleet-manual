...
![Reference](../_assets/icons/reference-light.svg) Verified against Fleet 4.91.0. The default fleet for user-driven Windows MDM enrollments arrived in 4.91.0. The Microsoft licensing requirements and the Entra console layout are vendor-owned and change on Microsoft's schedule, not Fleet's.
