...
![Explanation](../_assets/icons/explanation.svg) The WSTEP certificate and key serve two purposes: Windows enrollment and protection of escrowed disk encryption keys. Preserve the original pair so Fleet can decrypt credentials stored against that certificate.
