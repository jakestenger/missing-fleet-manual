...
5. **Technician** can run scripts, view their results, and install or uninstall software. Nothing else. It is a deliberately narrow role, and it is the natural fit for a help desk that needs to fix machines without being able to reconfigure the estate. Premium.
