...
<!-- DIAGRAM: Scope diagram, roles against reach. Two nested rounded rectangles. Outer
...
- [1.3 Hosts, fleets, labels, and targeting](../01-foundations/1.3-hosts-fleets-labels.md)
- [1.4 Identity and roles](../01-foundations/1.4-identity-and-roles.md)
