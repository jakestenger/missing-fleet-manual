...
Open `index.html` for all nine candidates at 720 px reading width. It includes a grayscale toggle, expanded view, and the previous labels diagram for comparison. These are review candidates, not accepted artwork. The book keeps its current published images and prose; all nine TODO/REDO markers remain pending.
