...
- **Opening claim ("A cell answers what an administrator can actually obtain...") read as an
  abstract assertion before the concrete mechanism.** Reworded to state the finding directly
