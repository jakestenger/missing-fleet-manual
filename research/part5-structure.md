...
| 5.7 | Control devices and send custom MDM commands | Supported device actions and custom commands; lock, unlock, locate and wipe by platform; the transport behind each action; custom Apple and Windows commands; status, results and retry; cancellation and irreversible actions |
