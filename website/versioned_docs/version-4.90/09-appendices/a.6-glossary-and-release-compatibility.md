...
![Reference](../_assets/icons/reference-light.svg) This edition covers Fleet 4.90.0. Its generated [configuration catalog](a.3-configuration-model-and-precedence.md#the-complete-configuration-key-catalog) and [route catalog](a.8-api-action-and-endpoint-reference.md#the-complete-route-catalog) describe that release. Each chapter’s `verified_against` frontmatter records its verification version.
