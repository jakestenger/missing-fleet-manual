...
The Fleet server gives administrators and automated workflows a shared point of coordination. It keeps the configuration you want to apply, receives information from devices, and arranges the work that connects the two. Understanding the services behind it helps you plan capacity, recovery, and the responsibilities of the people who operate Fleet.
...
![Explanation](../_assets/icons/explanation.svg) Fleet uses three stores for different workloads. Knowing what each holds helps you choose the right backup and availability arrangements.
