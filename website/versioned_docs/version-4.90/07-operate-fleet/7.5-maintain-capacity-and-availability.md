...
![Explanation](../_assets/icons/explanation-light.svg) Fleet's application tier scales horizontally against shared stores. That sentence is most of the good news, and the rest of the chapter is about the constraints it hides.
...
![Reference](../_assets/icons/reference-light.svg) Four facts that bound every decision below.
...
![How-to](../_assets/icons/howto-light.svg) Adding capacity is one of several answers, and often not the right one.
...
![Troubleshooting](../_assets/icons/troubleshooting-light.svg) The one place where adding instances actively hurts.
...
![Reference](../_assets/icons/reference-light.svg) Three dependencies, three different constraints, none of them Fleet's.
...
![Troubleshooting](../_assets/icons/troubleshooting-light.svg) What each loss costs, and one that is worse than it looks.
...
![How-to](../_assets/icons/howto-light.svg) The only way any of the above stops being a belief.
...
![How-to](../_assets/icons/howto-light.svg) The step that keeps the rest current.
