...
![Explanation](../_assets/icons/explanation-light.svg) Most of what this chapter covers has a date on it. Certificates expire, tokens expire, a licence expires, and the consequences of each arriving unhandled range from an inconvenience to losing the ability to decrypt your own disks.
...
![Reference](../_assets/icons/reference-light.svg) What Fleet depends on, and what breaks when each one lapses.
...
![How-to](../_assets/icons/howto-light.svg) Almost none of this warns you in advance.
...
![How-to](../_assets/icons/howto-light.svg) The failure mode is an estate that goes quiet.
...
![Troubleshooting](../_assets/icons/troubleshooting-light.svg) The section where a routine renewal can cost you your recovery credentials.
...
![Reference](../_assets/icons/reference-light.svg) One instruction, and it is the chapter's most important.
...
![How-to](../_assets/icons/howto-light.svg) The mechanics vary; the sequence does not.
...
![Troubleshooting](../_assets/icons/troubleshooting-light.svg) What a review can establish, and what it cannot.
...
![How-to](../_assets/icons/howto-light.svg) Decided in advance, because none of it is quick to work out during.
...
![Reference](../_assets/icons/reference-light.svg) What each role and each API-only identity may do, by scope, is in [a.4](../09-appendices/a.4-roles-and-permissions-matrix.md). Authentication and versioning for the endpoints these credentials call is in [a.8](../09-appendices/a.8-api-action-and-endpoint-reference.md).
